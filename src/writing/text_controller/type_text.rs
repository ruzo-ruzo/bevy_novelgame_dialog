...
pub(in crate::writing) struct CurrentTextAreaQuery<'w, 's> {
...
pub(in crate::writing) struct TypingTimer {
    pub timer: Timer,
}

#[derive(Debug)]
pub(in crate::writing) struct CharPos {
    pub x: f32,
    pub y: f32,
}

#[derive(Debug)]
pub(in crate::writing) struct LastChar {
...
pub(in crate::writing) struct CurrentQuery<'w, 's> {
